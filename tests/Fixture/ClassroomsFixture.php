...
class ClassroomsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cycle' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'teacher_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'kid_id' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        '_indexes' => [
            'BY_TEACHER_ID' => ['type' => 'index', 'columns' => ['teacher_id'], 'length' => []],
            'BY_KID_ID' => ['type' => 'index', 'columns' => ['kid_id'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'teacher_id' => 1,
            'kid_id' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
