...
class SchoolsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'adress' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'cs_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'BY_CS_ID' => ['type' => 'index', 'columns' => ['cs_id'], 'length' => []],
        ],
        '_constraints' => [
