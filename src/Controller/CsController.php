 ...
 * Cs Controller
 *
 * @property \App\Model\Table\CsTable $Cs
 */
class CsController extends AppController
{
    ...
    {
        $this->set('cs', $this->paginate($this->Cs));
        $this->set('_serialize', ['cs']);
    }
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            $c = $this->Cs->patchEntity($c, $this->request->data);
            if ($this->Cs->save($c)) {
